...
\centering
\begin{tabular}{c c}
\includegraphics[width=0.20\linewidth]{img/region_of_influence.png}
&
\includegraphics[width=0.20\linewidth]{img/characteristictriangle.png}
\\
...
\begin{itemize}[leftmargin=10pt, itemsep=0pt, topsep=0pt]
    ...
    \item \textbf{N} (Neumann): $u_x(0,t)=0,\;u_x(L,t),t=0$
