% content/cleanup.tex - this is the newly structured document
...
\begin{align*}
  \frac{dx}{dt} = x & &  \implies & x(t) = C_{1}e^t && \implies x(s)=se^t\\
  & &  & x(0) = C_{1} \stackrel{!}{=} s \\
...
$\to f:\mathbb{R}\to\mathbb{R}$ flux function, $c(u)=f'(u)$
