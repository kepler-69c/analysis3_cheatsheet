...
\begin{itemize}[leftmargin=10pt, itemsep=1pt, topsep=1pt]
    \item \textbf{D} = Dirichlet: $u(0)=0,\;u(L)=0$
    \item \textbf{N} = Neumann: $u_x(0)=0,\;u_x(L)=0$ ("no flux")
    \item \textbf{DN} = Mixed: $u(0)=0,\;u_x(L)=0$
    \item \textbf{ND} = Mixed: $u_x(0)=0,\;u(L)=0$
    \item \textbf{R} = Robin (Mixed):
    \[
