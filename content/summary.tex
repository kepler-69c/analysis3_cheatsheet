...
\hl{TODO: add compatibility condition}
...
\hl{TODO: add compatibility condition (6.3.5)}
...
\begin{enumerate}
 \item \textbf{Weak maximum principle:} $D$ bounded domain, $u\in C^2(D) \cap C(\overline{D})$, $u$ harmonic $\implies \max_{\overline{D}} u = \max_{\partial D}u$
