...
\titleformat{\section}
{\large\bfseries}{}{0pt}{%
\begin{tcolorbox}[arc=0pt,boxsep=0pt,boxrule=0pt,left=6pt,right=6pt,top=2pt,bottom=3pt,middle=0pt,nobeforeafter,colback=cyan!50!blue]\color{white}\thesection.~#1\end{tcolorbox}}
